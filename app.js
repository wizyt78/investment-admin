...
let token=localStorage.getItem("ip_admin_token")||"",me=null;
...
function applyLang(){document.documentElement.lang="en";document.documentElement.dir="ltr";document.querySelectorAll("[data-i18n]").forEach(e=>e.textContent=tr(e.dataset.i18n));document.querySelectorAll("[data-i18n-placeholder]").forEach(e=>e.placeholder=tr(e.dataset.i18nPlaceholder))}
...
if(localStorage.getItem("ip_admin_theme")!=="light")document.body.classList.add("dark");
boot();
